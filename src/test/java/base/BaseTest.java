...
public WebDriver createYandexDriver() {
    ...
    // из-за разногласий версий на моем ПК пришлось чуть усложнить
    ChromeOptions options = new ChromeOptions();
    options.setBinary("C:/Users/Olesya/Downloads/chrome140/chrome-win64/chrome.exe");
    ...
    options.setCapability("browserVersion", "140");
